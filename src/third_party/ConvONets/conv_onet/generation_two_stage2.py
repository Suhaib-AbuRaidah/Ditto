...
try:
    ...
    from src.third_party.ConvONets.utils.Mesh_from_pcs import mesh_from_points, generate_mesh_dict_from_segments
...
class Generator3D(object):
    ...
    def generate_mesh(self, data, seg_pcs, return_stats=True):
        ...
        mesh_dict = generate_mesh_dict_from_segments(seg_pcs[0],seg_pcs[1])

        if return_stats:
            return mesh_dict, c, stats_dict
        else:
            return mesh_dict, c
